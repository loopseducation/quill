...
var BaseTooltip = function (_Tooltip) {
  ...
  _createClass(BaseTooltip, [{
    ...
    value: function edit() {
      ...
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { create: true };
...
var FormulaBlot = function (_Embed) {
  ...
  function FormulaBlot(node) {
    _classCallCheck(this, FormulaBlot);

    var _this = _possibleConstructorReturn(this, (FormulaBlot.__proto__ || Object.getPrototypeOf(FormulaBlot)).call(this, node));

    _this.text = _this.statics.value(node);
    return _this;
  }
  ...
  _createClass(SnowTooltip, [{
    ...
    value: function listen() {
      ...
      this.quill.on(_emitter2.default.events.SELECTION_CHANGE, function (range, oldRange, source) {
        if (range == null) return;
        var inputPreview = _this3.root.querySelector('a.ql-preview');
        if (range.length === 0 && source === _emitter2.default.sources.USER) {
          ...
          var _quill$scroll$descend3 = _this3.quill.scroll.descendant(_formula.FormulaBlot, range.index),
              _quill$scroll$descend4 = _slicedToArray(_quill$scroll$descend3, 2),
              formula = _quill$scroll$descend4[0],
              formulaOffset = _quill$scroll$descend4[1];

          if (formula != null) {
            _this3.linkRange = new _selection.Range(range.index - formulaOffset, formula.length());
            var formulaPreview = _formula.FormulaBlot.value(formula.domNode);
            inputPreview.value = formulaPreview;
            _this3.show();
            _this3.edit('formula', formulaPreview, { create: false });
            _this3.position(_this3.quill.getBounds(_this3.linkRange));
            return;
          }
        } else {
